...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--sqp-iters", type=int, default=None)
    p.add_argument("--sqp-step-size", type=float, default=None)
    p.add_argument("--riccati-reg", type=float, default=None)
...
def main() -> None:
    ...
    if args.visualize or args.animate:
        try:
            ...
            if args.show:
                print("[eval] Opening interactive matplotlib window(s).")
                plt.show()
        except ImportError:
