...
from .objective_primal_sqp import primal_objective_sqp
from ..tree.sqp_tree import SQPConfig
...
def run_outer_optimization(
    ...
    sqp_cfg = SQPConfig(max_iters=5, step_size=1.0, reg=1e-5, detach_linearization=True)
